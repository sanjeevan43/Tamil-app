...
class TamilWordFilterService {
  ...
  static const Set<String> commonEverydayWords = {
    ...
    'மாமி', 'மாமியார்', 'மாமன்', 'மாமனார்',

    // Daily activities
    'சாப்பிடு', 'குடி', 'தூங்கு', 'எழு', 'நடக்கு', 'ஓடு',
    'பாடு', 'நாடு', 'விளையாடு', 'படி', 'எழுது', 'பேசு',
    'கேட்கு', 'பார்க்கு', 'சிரிக்கு', 'அழு', 'சிந்திக்கு',

    // Common objects
    'வீடு', 'பள்ளி', 'புத்தகம்', 'பேனா', 'பேப்பர்', 'மேஜை',
    'நாற்காலி', 'கதவு', 'ஜன்னல்', 'விளக்கு', 'ரேடியோ', 'தொலைக்காட்சி',
    'மொபைல்', 'கணினி', 'பாத்திரம்', 'கப்பு', 'தட்டு', 'கரண்டி',

    // Food & drink
    'சாதம்', 'சாம்பார்', 'ரசம்', 'பொரியல்', 'பூரி', 'தோசை',
    'இட்லி', 'வடை', 'பிரியாணி', 'பிரெட்', 'பால்', 'தண்ணீர்',
    'தேநீர்', 'காபி', 'பழம்', 'பொரி', 'சாக்லேட்', 'ஐஸ்கிரீம்',

    // Nature
    'மரம்', 'பூ', 'இலை', 'கிளை', 'வேர்', 'விதை',
    'சூரியன்', 'நிலா', 'நட்சத்திரம்', 'மேகம்', 'மழை', 'காற்று',
    'நீர்', 'கடல்', 'மலை', 'வயல்', 'பூங்கா', 'காடு',

    // Animals
    'நாய்', 'பூனை', 'யானை', 'சிங்கம்', 'புலி', 'குரங்கு',
    'பறவை', 'மீன்', 'பாம்பு', 'தவளை', 'சிலந்தி', 'எறும்பு',
    'வண்டு', 'தேனீ', 'பூச்சி', 'கோழி', 'வாத்து', 'ஆடு',

    // Colors
    'சிவப்பு', 'நீலம்', 'பச்சை', 'மஞ்சள்', 'வெள்ளை', 'கருப்பு',
    'ஆரஞ்சு', 'ஊதா', 'சாம்பல்', 'பழுப்பு', 'இளஞ்சிவப்பு',
    ...
    // Body parts
    'தலை', 'முகம்', 'கண்', 'மூக்கு', 'வாய்', 'பல்',
    'நாக்கு', 'காது', 'கை', 'விரல்', 'கால்', 'கணுக்கால்',
    'மார்பு', 'வயிறு', 'முதுகு', 'தோல்', 'எலும்பு', 'இரத்தம்',

    // Feelings & emotions
    'மகிழ்ச்சி', 'சந்தோஷம்', 'அன்பு', 'பயம்', 'கோபம்', 'வருத்தம்',
    'சோகம்', 'ஆச்சரியம்', 'வெட்கம்', 'பெருமை', 'நம்பிக்கை',

    // Time
    'நாள்', 'இரவு', 'பகல்', 'மணி', 'நிமிடம்', 'வினாடி',
    'வாரம்', 'மாதம்', 'வருடம்', 'ஆண்டு', 'இன்று', 'நாளை',
    'நேற்று', 'இப்போது', 'பிறகு', 'முன்',

    // Seasons
    'கோடை', 'குளிர்', 'மழைக்காலம்', 'வசந்தம்', 'இலையுதிர்',
    ...
    'விரைவான', 'மெதுவான', 'வலிமையான', 'பலவீனமான', 'ஆரோக்கியமான',

    // Places
    'வீடு', 'பள்ளி', 'கோயில்', 'மசூதி', 'சர்ச்', 'கடை',
    'சந்தை', 'பொலிசு', 'மருத்துவமனை', 'பேருந்து', 'ரயில்', 'விமானம்',
    'நகரம்', 'கிராமம்', 'தெரு', 'சாலை', 'பாலம்', 'பூங்கா',

    // Professions
    'ஆசிரியர்', 'மாணவர்', 'மாணவி', 'வேலைக்காரர்', 'பொலிசு', 'வைத்தியர்',
    'நர்ஸ்', 'பொறியாளர்', 'கணக்கர்', 'வக்கீல்', 'விவசாயி', 'வணிகர்',

    // Greetings & expressions
    'வணக்கம்', 'நமஸ்காரம்', 'ஆசிர்வாதம்', 'தகவல்', 'செய்தி', 'கேள்வி',
    'பதில்', 'ஆம்', 'இல்லை', 'சரி', 'சரியல்ல', 'தவறு',
    ...
    // Prepositions
    'மேல்', 'கீழ்', 'உள்ளே', 'வெளியே', 'முன்', 'பின்',
    'வலது', 'இடது', 'நடுவே', 'பக்கத்தில்', 'அருகில்', 'தூரத்தில்',

    // Conjunctions
    'மற்றும்', 'அல்லது', 'ஆனால்', 'ஏனெனில்', 'அதனால்', 'இருந்தாலும்',

    // Articles & determiners
    'ஒரு', 'இரண்டு', 'மூன்று', 'சில', 'பல', 'அனைத்து',
    'ஒவ்வொரு', 'எந்த', 'இந்த', 'அந்த', 'இவ்வளவு', 'அவ்வளவு',

    // Possessives
    'என்', 'உன்', 'அவன்', 'அவள்', 'நம்', 'உங்கள்', 'அவர்களின்',

    // Pronouns
    'நான்', 'நீ', 'அவன்', 'அவள்', 'அது', 'நாம்', 'நீங்கள்', 'அவர்கள்',

    // Modern/Contemporary words
    'கணினி', 'மொபைல்', 'ஸ்மார்ட்ஃபோன்', 'ஆப்', 'ইন்டர்நெட்', 'ওয়াய்ஃபை',
    'ভিডியோ', 'ফটோ', 'ক্যামেরা', 'ডিজিটல்', 'ইমেல்', 'চ্যাট்',
  };

  // Words that are too formal/literary
  static const Set<String> formalLiteraryWords = {
    'ஆகிய', 'ஆகும்', 'ஆயிற்று', 'ஆயினும்', 'ஆயினால்',
    'ஆயிரம்', 'ஆயுள்', 'ஆயுஷ்', 'ஆயுஷ்மான்',
    'ஆயோ', 'ஆயோ', 'ஆயோ',
    'அவ்வாறு', 'அவ்வாறே', 'அவ்வாறிய',
    'இவ்வாறு', 'இவ்வாறே', 'இவ்வாறிய',
    'உவ்வாறு', 'உவ்வாறே', 'உவ்வாறிய',
    'ஏவம்', 'ஏவ', 'ஏவல்',
    'ஐயம்', 'ஐயோ', 'ஐயோ',
    'ஒவ்வொரு', 'ஒவ்வொருவர்',
    'கூறிய', 'கூறினர்', 'கூறினாள்', 'கூறினான்',
    'சொல்லிய', 'சொல்லினர்', 'சொல்லினாள்', 'சொல்லினான்',
    'தெரிந்த', 'தெரிந்தவர்', 'தெரிந்தவள்', 'தெரிந்தவன்',
    'நினைந்த', 'நினைந்தவர்', 'நினைந்தவள்', 'நினைந்தவன்',
    'பெற்ற', 'பெற்றவர்', 'பெற்றவள்', 'பெற்றவன்',
    'வந்த', 'வந்தவர்', 'வந்தவள்', 'வந்தவன்',
    'செய்த', 'செய்தவர்', 'செய்தவள்', 'செய்தவன்',
    'கொண்ட', 'கொண்டவர்', 'கொண்டவள்', 'கொண்டவன்',
    'விட்ட', 'விட்டவர்', 'விட்டவள்', 'விட்டவன்',
    'போன', 'போனவர்', 'போனவள்', 'போனவன்',
    'வாழ்ந்த', 'வாழ்ந்தவர்', 'வாழ்ந்தவள்', 'வாழ்ந்தவன்',
    'இறந்த', 'இறந்தவர்', 'இறந்தவள்', 'இறந்தவன்',
    'பிறந்த', 'பிறந்தவர்', 'பிறந்தவள்', 'பிறந்தவன்',
    'வளர்ந்த', 'வளர்ந்தவர்', 'வளர்ந்தவள்', 'வளர்ந்தவன்',
    'கற்ற', 'கற்றவர்', 'கற்றவள்', 'கற்றவன்',
    'கேட்ட', 'கேட்டவர்', 'கேட்டவள்', 'கேட்டவன்',
    'பார்த்த', 'பார்த்தவர்', 'பார்த்தவள்', 'பார்த்தவன்',
    'சிந்தித்த', 'சிந்தித்தவர்', 'சிந்தித்தவள்', 'சிந்தித்தவன்',
    'மறந்த', 'மறந்தவர்', 'மறந்தவள்', 'மறந்தவன்',
    'நினைத்த', 'நினைத்தவர்', 'நினைத்தவள்', 'நினைத்தவன்',
    'விரும்பிய', 'விரும்பியவர்', 'விரும்பியவள்', 'விரும்பியவன்',
    'விரும்பாத', 'விரும்பாதவர்', 'விரும்பாதவள்', 'விரும்பாதவன்',
    'விரும்பிய', 'விரும்பியவர்', 'விரும்பியவள்', 'விரும்பியவன்',
    'விரும்பாத', 'விரும்பாதவர்', 'விரும்பாதவள்', 'விரும்பாதவன்',
    'விரும்பிய', 'விரும்பியவர்', 'விரும்பியவள்', 'விரும்பியவன்',
    'விரும்பாத', 'விரும்பாதவர்', 'விரும்பாதவள்', 'விரும்பாதவன்',
  ...
  static const Set<String> technicalSpecializedWords = {
    'ஆயுர்வேதம்', 'சித்தவைத்தியம்', 'ইউனानী', 'হোমিওপ্যাথি',
    'ফিজিওথেরাপি', 'সাইকোলজি', 'সোশিওলজি', 'এন্থ্রোপোলজি',
    'আর্কিওলজি', 'জিওলজি', 'বায়োলজি', 'কেমিস্ট্রি',
    'ফিজিক্স', 'ম্যাথমেটিক্স', 'জিওমেট্রি', 'এলজেব্রা',
    'ট্রিগোনোমেট্রি', 'ক্যালকুলাস', 'স্ট্যাটিস্টিক্স', 'প্রোবাবিলিটি',
  };
  ...
  int getCommonalityScore(String word) {
    ...
    // Base score
    if (isCommonEverydayWord(word)) score += 100;
    else if (isLiteraryWord(word)) score -= 50;
    else if (isTechnicalWord(word)) score -= 30;
    else if (containsRareCharacters(word)) score -= 40;
    else if (isLikelyRareWord(word)) score -= 20;
    else score += 30; // Unknown words get moderate score

    // Adjust based on word length (shorter words are usually more common)
    if (word.length <= 3) score += 10;
    else if (word.length <= 6) score += 5;
    else if (word.length > 12) score -= 10;
