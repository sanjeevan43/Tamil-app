  ...
  void _handleAnswer(dynamic selected) {
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      ...
      if (isCorrect) {
        ...
        final quotes = TamilData.motivationalQuotes;
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Icon(Icons.close, size: 20, color: Color(0xFF5D4037)),
                ),
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _timeLeft <= 10 ? Colors.red[50] : Colors.grey[100],
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.timer, size: 16,
                        color: _timeLeft <= 10 ? Colors.red : Colors.grey[600]),
        ...
        children: [
          ...
          if (_showFeedback)
            Icon(
              ...
              color: _lastAnswerCorrect ? const Color(0xFF66BB6A) : Colors.red,
              size: 48,
            ),
        ],
      ),
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isMatched
                          ...
                          : (isFlipped ? Colors.white : widget.stageColor),
                      borderRadius: BorderRadius.circular(16),
                      border: Border.all(
                        color: isMatched
                            ? const Color(0xFF66BB6A)
