class TamilData {
  ...
  static const List<String> aayudhaEzhuthu = ['ஃ'];

  // Base list of K to N (Akaram)
  static const List<String> uyirMeiBase = [
    'க', 'ங', 'ச', 'ஞ', 'ட', 'ண', 'த', 'ந', 'ப', 'ம', 
    'ய', 'ர', 'ல', 'வ', 'ழ', 'ள', 'ற', 'ன'
  ];

  // Map of all 216 combinations by vowel series
  static const List<List<String>> uyirMeiEzhuthukkal = [
  ...
  static const List<Map<String, dynamic>> tamilRhymes = [
    ...
    },
    {
      ...
      'lines': [
        ...
        {'content': 'Malligai poo kondu va', 'image': 'rhyme_moon_4'},
      ],
    },
    {
      'title': 'ஆத்திச்சூடி',
